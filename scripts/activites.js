...
//helper function
let activitiesSelect = document.getElementById("activitiesList");
    activitiesSelect.onclick = showActivitesList;
...
//helper function to hide or show sections of the page

function showActivitesList(){
    const selectbtn = document.getElementById("selectbtn");
    let activitiesSelect = document.getElementById("activitiesList");
